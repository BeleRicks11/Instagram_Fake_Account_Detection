...
def add_header():
    with open('NewDataSet.csv', mode='w') as csv_file:
        fieldNames = ['Profile Pic','Nums/Length Username','Full Name Words','Bio Length','External Url','Verified','Business','#Posts','#Followers','#Following','Last Post Recent', '%Post Single Day', 'Index of Activity', 'Average of Likes','Fake','Profile Pic Url', 'Username']
...
for account in usernameList:
    ...
    #Profile Pic Url
    details['Username']=str(account.username)
